...
import { getFilteredPostsWithAccId } from '../modules/fetch/post';

const SearchPost = ({ updatePosts, account_id }) => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await getFilteredPostsWithAccId(filterData);
